...
const getAllPayments = async (req, res, next) => {
  try {
    ...
    // Fetch all completed orders as payment history
    const payments = await Order.find({ orderStatus: "Completed" })
      .select("orderNumber customerDetails bills paymentMethod createdAt")
      .sort({ createdAt: -1 });
...
module.exports = { createOrder, verifyPayment, webHookVerification, getAllPayments };
