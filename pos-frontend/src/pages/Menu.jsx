...
const Menu = () => {
  ...
  return (
    <section className="bg-[#1f1f1f] h-screen flex flex-col">
      {/* Main Content Area */}
      <div className="flex-1 flex gap-3 overflow-hidden pb-20">
        {/* Left Div - Menu */}
        <div className={`${isAdminMode ? "w-full px-4" : "flex-[3]"} flex flex-col overflow-hidden`}>
        ...
        {/* Right Div - Cart & Bill */}
        {!isAdminMode && (
          <div className="flex-[1] bg-[#1a1a1a] mt-4 mr-3 rounded-lg pt-2 flex flex-col max-h-[calc(100vh-7rem)]">
            {/* Customer Info */}
            <CustomerInfo />
